...
extensions = [
    ...
    # Define top down hierarchy in _toc.yml instead of in every sub page
    "sphinx_external_toc",
    # For the card element
    "sphinx_design",
    # Enable Markedly Structured Text | https://myst-parser.readthedocs.io
    "myst_parser",
...
# Breathe Config
breathe_projects = {"pmacFilterControl": "doxygen/_build/xml/"}
breathe_default_project = "pmacFilterControl"
